package arh_calc_002;

import java.util.Arrays;
import java.util.Scanner;

public class Main_arh_calc_002 {
    public static void main(String[] args) throws Exception {
        ...
        if (pfTips(ppMasElements[0], ppValidnyeSimvolyArab) && pfTips(ppMasElements[2], ppValidnyeSimvolyArab)) {
            ...
            System.out.printf("Цифры определены как Арабские\nБудет произведено вычисление: [%s]\n", ppSring001);
            ...
            System.out.printf("Цифры определены как Римские\nБудет произведено вычисление: [%s]\n", ppSring001);
